...
class Localization extends \App\Http\Controllers\Controller {
    ...
    public static function getCurrencies() {
        ...
        //$allowedCurrencies = ['AUD', 'GBP', 'AUD', 'CAD', 'DKK', 'EUR', 'HKD', 'ISK', 'INR', 'ILS', 'JPY', 'JOD', 'KES', 'KWD', 'NOK', 'KRW', 'SEK', 'CHF', 'USD'];
        ...
        foreach ($currencies as $currency_code => $currency) {
            if ((isset($allowedCurrencies) && in_array($currency_code, $allowedCurrencies)) || ! isset($allowedCurrencies)) {
