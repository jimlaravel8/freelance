...
class InstallationController extends \App\Http\Controllers\Controller {
  ...
  public function postInstall(Request $request) {
    ...
    $first_name = $response['adminFirstName'];
    $last_name = $response['adminLastName'];
    ...
    // Filter
    $all = [];
    $filter = ['loading', 'adminFirstName', 'adminLastName', 'adminEmail', 'adminPassword', 'hasError', 'errors', 'success'];
