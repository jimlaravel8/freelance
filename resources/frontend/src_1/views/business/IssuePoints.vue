                        ...
                        >
                          <i18n path="issue_points_configure_rules">
                            <template #configure_the_rules>
                              ...
                              >{{ $t('configure_the_rules').toLowerCase() }}</router-link>
                            </template>
                          </i18n>
                        </p>
                            ...
                            <v-row no-gutters>
                              ...
                              <v-col cols="4">
                                <v-btn
                                  ...
                                  height="56px"
                                  :loading="verifyCustomerNumberForm.loading"
                                  :disabled="verifyCustomerNumberForm.loading || invalid"
                                >
                                  {{ $t('verify') }}
          ...
          <v-card>
            ...
            <v-card-actions>
              ...
              <v-btn
                ...
                class="no-caps"
                text
                @click="dialogIssuePoints = false"
              >{{ $t('close') }}</v-btn>
              <v-btn
                color="NavBg NavFg--text"
                class="no-caps"
                depressed
                :loading="issuePointsForm.loading"
                :disabled="issuePointsForm.loading || invalid"
                type="submit"
              >{{ $t('issue_points') }}</v-btn>
            </v-card-actions>
          </v-card>
        </v-form>
      </ValidationObserver>
