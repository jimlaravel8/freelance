<template>
  <div class="viewContainer" v-resize="onResize">
    ...
    <v-dialog
      v-model="dialogGenerateDiscountCode"
      persistent
      max-width="400"
              ...
              <v-card-text>
                ...
                <div class="mt-5">
                  <x-text-field
                    ...
                    @click:append="copyStringToClipboard2(generateDiscountCodeForm.code)"
                  />
                </div>
                <qrcode
                  class="mt-0"
      ...
      this.axios
        ...
        .then(response => {
          if (response.data.status === "success") {
            ...
            this.discountCode = response.data.code;
...
<style >
.NavBgBlue {
  background-color: #073697 !important;
  border-color: #073697 !important;
}
</style>