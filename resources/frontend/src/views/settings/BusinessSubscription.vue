                        ...
                        <v-row no-gutters>
                                    ...
                                    <v-card-text>
                                        <v-card outlined>
                                            ...
                                            <div v-if="billings.loaded && billings.status_code == 200 && transactionMonth != ''" class="ma-5">
                                                ...
                                                <v-input prepend-icon="mdi-cash" color="black" :messages="[`Amount Due`]">{{this.billings.due_details.amount}}</v-input>

                                                <v-input prepend-icon="mdi-file-document" color="black" :messages="['Invoice NO']">{{this.billings.invoice_no}}</v-input>
                                                <v-input :messages="['Payment Status']">
                                                    <v-icon slot="prepend" :color="billings.due_details.status == 1 ? 'green' : 'red'">{{this.billings.due_details.status == 1 ? 'mdi-check' : 'mdi-close'}}</v-icon>
                            ...
                            <v-col cols="12" sm="12" md="12">
                                <v-card flat tile class="pa-5 mb-0 mb-md-12">
                                    <v-card-text>
                                        <v-card outlined>
                                            <v-data-table :headers="billings.headers" :items="billings.transactions" :items-per-page="5" class="elevation-1"></v-data-table>
                                        </v-card>
                                    </v-card-text>
                                </v-card>
                            </v-col>
