                ...
                <v-row no-gutters>
                  <v-col cols="12" sm="6">
                    <v-card flat tile class="content-tabs-card pa-5 mb-0 mb-md-12">
                      <v-card-text>
                        <h1
                          class="fg--text display-2 font-weight-medium"
                          style="line-height: 4rem; max-width: 310px"
                        >{{ $t('about_tab1_title') }}</h1>
                  ...
                  <v-col cols="12" sm="6">
                    <v-card flat tile class="content-tabs-card pa-5 mb-0 mb-md-12">
                      <v-card-text>
                        <h1
                          class="fg--text display-2 font-weight-medium"
                          style="line-height: 4rem; max-width: 280px"
                        >{{ $t('about_tab2_title') }}</h1>
                        ...
                        >{{ $t('about_tab2_desc3') }}</p>
                        <p class="fg--text title">{{ $t('about_tab2_title2') }}</p>
                        <p class="fg--text subtitle-1">{{ $t('about_tab2_desc4') }}</p>
                        <p
                          class="fg--text mb-0 subtitle-1 pl-4 font-weight-medium"
                          style="border-left: 4px solid #ccc;"
                        >{{ $t('about_tab2_desc5') }}</p>
                        <p
                          class="fg--text pt-4 subtitle-1 pl-4 font-weight-medium"
                          style="border-left: 4px solid #ccc;"
                        >{{ $t('about_tab2_desc6') }}</p>
                        <v-btn
                          v-if="!$auth.check()"
                          class="mt-5 no-caps"
                          color="ctaBg ctaFg--text"
