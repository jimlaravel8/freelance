      ...
      <v-container class="inner-container">
        <v-row no-gutters>
          ...
          <div class="d-flex align-center">
            <router-link v-if="$init.app.logo != '' && $init.app.logo != null" :to="{name: 'home'}"><v-img width="144" :src="$init.app.logo"/></router-link>
          ...
          <div class="d-flex align-center ml-2" v-if="!$auth.check()">
            <v-btn color="NavFg NavBg--text" depressed tile class="no-caps" :to="{name: 'register'}">{{ $t('sign_up') }}</v-btn>
          </div>
        </v-row>
      </v-container>
    </v-app-bar>
