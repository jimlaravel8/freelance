                                        ...
                                        <v-overlay v-if="hover" absolute>
                                          <v-btn-toggle rounded>
                                            ...
                                            <v-btn
                                              ...
                                              @click="form1.avatar_media_url = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAIAAACQd1PeAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAA9JREFUeNpiuHbtGkCAAQAFCAKDZcGh3gAAAABJRU5ErkJggg=='; form1.avatar_media_changed = true; showDeleteAvatar = false"
                                              x-small
                                              color="red"
                                              rounded
                                            >
