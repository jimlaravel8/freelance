            ...
            >
              <v-card elevation="20" :outlined="false">
                ...
                <div v-if="installed">
                  ...
                  <v-divider/>
                  <v-card-actions>
                    <v-btn color="ctaBg ctaFg--text" depressed x-large block :to="{name: 'home'}">Visit homepage</v-btn>
                  </v-card-actions>
                </div>
                ...
                <v-stepper v-model="step" vertical style="border-top-left-radius: 0; border-top-right-radius: 0" v-if="!installed && !form1.loading">
                  <v-stepper-step :complete="step > 1" step="1" color="secondary">
                    Requirements
                  </v-stepper-step>
                  <v-stepper-content step="1">
                    ...
                    <div class="my-5">
                      <v-btn color="ctaBg ctaFg--text" depressed @click="step = 2" :disabled="!allRequirementsMet">Next <v-icon class="ml-1" size="15">mdi-arrow-right</v-icon></v-btn>
                    </div>
                  </v-stepper-content>
                  ...
                  <v-stepper-content step="2">
                    ...
                    <x-text-field
                      ...
                      hint="This email address is visible on the website for visitors to contact you."
                      persistent-hint
                    />
                    <div class="my-5">
                      <v-btn color="ctaFg--text" text @click="step = 1" class="mr-2"><v-icon class="mr-1" size="15">mdi-arrow-left</v-icon> Back</v-btn>
                      <v-btn color="ctaBg ctaFg--text" depressed @click="step = 3">Next <v-icon class="ml-1" size="15">mdi-arrow-right</v-icon></v-btn>
                    </div>
                  </v-stepper-content>
                  ...
                  <v-stepper-content step="3">
                    ...
                    />
                    <div class="my-5">
                      <v-btn color="ctaFg--text" text @click="step = 2" class="mr-2"><v-icon class="mr-1" size="15">mdi-arrow-left</v-icon> Back</v-btn>
                      <v-btn color="ctaBg ctaFg--text" depressed @click="step = 4">Next <v-icon class="ml-1" size="15">mdi-arrow-right</v-icon></v-btn>
                    </div>
                  </v-stepper-content>

                  <v-stepper-step :complete="step > 4" step="4" color="secondary">
                    Login
                  </v-stepper-step>
                  <v-stepper-content step="4">
                    ...
                    <v-row>
                      <v-col cols="12" sm="6" class="py-0">
                        <x-text-field 
                          v-model="form1.adminFirstName"
                          ref="form1.adminFirstName"
                          id="form1.adminFirstName"
                          :label="$t('first_name')"
                          :name="$t('first_name')"
                      ...
                      <v-col cols="12" sm="6" class="py-0">
                        <x-text-field 
                          v-model="form1.adminLastName"
                          ref="form1.adminLastName"
                          id="form1.adminLastName"
                          :label="$t('last_name')"
                          :name="$t('last_name')"
                          rules="required|min:1|max:32"
                          dense
                    ...
                    />
                    <div class="my-5">
                      <v-btn color="ctaFg--text" text @click="step = 3" class="mr-2"><v-icon class="mr-1" size="15">mdi-arrow-left</v-icon> Back</v-btn>
                      <v-btn color="ctaBg ctaFg--text" depressed @click="step = 5">Next <v-icon class="ml-1" size="15">mdi-arrow-right</v-icon></v-btn>
                    </div>
                  </v-stepper-content>

                  <v-stepper-step :complete="step > 5" step="5" color="secondary">
                    Database
                  </v-stepper-step>
                  <v-stepper-content step="5">
                    ...
                    />
                    <div class="my-5">
                      <v-btn color="ctaFg--text" text @click="step = 4" class="mr-2"><v-icon class="mr-1" size="15">mdi-arrow-left</v-icon> Back</v-btn>
                      <v-btn color="ctaBg ctaFg--text" depressed @click="step = 6">Next <v-icon class="ml-1" size="15">mdi-arrow-right</v-icon></v-btn>
                    </div>
                  </v-stepper-content>

                  <v-stepper-step :complete="step > 6" step="6" color="secondary">
                    Email
                  </v-stepper-step>
                  <v-stepper-content step="6">
                    <p>By default the "sendmail" driver is used, you can change this in the <code>.env</code> file in the web root after installation.</p>
                    <x-text-field
                    ...
                    />
                    <div class="my-5">
                      <v-btn color="ctaFg--text" text @click="step = 5" class="mr-2"><v-icon class="mr-1" size="15">mdi-arrow-left</v-icon> Back</v-btn>
                      <v-btn color="ctaBg ctaFg--text" depressed @click="step = 7">Next <v-icon class="ml-1" size="15">mdi-arrow-right</v-icon></v-btn>
                    </div>
                  </v-stepper-content>

                  <v-stepper-step :complete="step > 7" step="7" color="secondary">
                    Social
                  </v-stepper-step>
                  <v-stepper-content step="7">
                    ...
                    />
                    <div class="my-5">
                      <v-btn color="ctaFg--text" text @click="step = 6" class="mr-2"><v-icon class="mr-1" size="15">mdi-arrow-left</v-icon> Back</v-btn>
                      <v-btn color="ctaBg ctaFg--text" depressed @click="step = 8">Next <v-icon class="ml-1" size="15">mdi-arrow-right</v-icon></v-btn>
                    </div>
                  </v-stepper-content>

                  <v-stepper-step :complete="step > 8" step="8" color="secondary">
                    Install
                  </v-stepper-step>
                  <v-stepper-content step="8">
                    ...
                    >
                      <p>All settings can be changed after installation in the <code>.env</code> file in the web root.</p>
                      <p>Click the "INSTALL" button to finalize installation.</p>
                    </div>

                    <div class="my-5">
                      <v-btn color="ctaFg--text" text @click="step = 7" class="mr-2"><v-icon class="mr-1" size="15">mdi-arrow-left</v-icon> Back</v-btn>
                      <v-btn color="green white--text" depressed :loading="form1.loading" :disabled="requirements.length === 0 || !allRequirementsMet || form1.loading || invalid" type="submit"><v-icon class="mr-1" size="15">mdi-check</v-icon> Install</v-btn>
                    </div>
                  </v-stepper-content>
                </v-stepper>
              </v-card>
...
export default {
  data: () => ({
    ...
    form1: {
      ...
      APP_CONTACT_EMAIL: 'hi@' + location.hostname,
      adminFirstName: 'Admin',
      adminLastName: 'User',
      adminEmail: 'info@' + location.hostname,
      adminPassword: '',
      DEFAULT_LOCALE: '',
      DEFAULT_TIMEZONE: '',
      DB_HOST: '127.0.0.1',
  ...
  mounted() {
    ...
    this.$refs['form1.adminFirstName'].validate()
    this.$refs['form1.adminLastName'].validate()
