                  ...
                  >
                    <v-card flat tile class="content-tabs-card pa-5 mb-0 mb-md-12">
                      <v-card-text>
                        ...
                        <qrcode class="mt-0" :value="$init.config.schemeAndHost + '/business/issue-points?c=' + $auth.user().customer_number" :options="{ margin:0, width: 300, errorCorrectionLevel: 'H', color: { light: '#ffffff00', dark: ($vuetify.theme.dark) ? '#ffffff' : '#000000' } }"></qrcode>
                      </v-card-text>
                    </v-card>
                  </v-col>
                </v-row>
